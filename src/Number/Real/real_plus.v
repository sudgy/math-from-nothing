...
Theorem rat_to_real_plus : ∀ a b,
    ...
    apply predicate_ext; intros x; split.
    -   intros [r [s [ra [sb eq]]]].
        pose proof (lt_lrplus ra sb) as ltq.
        rewrite eq.
        exact ltq.
    -   intros eq.
        assert (∃ c, 0 < c ∧ x + c = a + b) as [c [c_pos c_eq]].
        {
            exists (a + b + -x).
            split.
            -   apply lt_plus_0_anb_b_a.
        ...
        exists (x + c * div 2 + -b), (-a + x + c * div 2).
        assert (c * div 2 < c) as c_ltq.
        {
