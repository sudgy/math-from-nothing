...
Proof.
    ...
    apply (inverse_ex_bijective lf g); split.
    -   apply func_eq.
        exact fg'.
    -   apply func_eq.
        exact gf'.
...
Proof.
    ...
    inversion fg as [fg']; clear fg.
    inversion gf as [gf']; clear gf.
    apply (inverse_ex_bijective cf g); split.
    -   apply func_eq.
        exact fg'.
    -   apply func_eq.
        exact gf'.
...
Theorem tensor_product_lriso_eq : ∀ a b, lrf (a ⊗1 b) = f1 a ⊗2 f2 b.
Proof.
...
Proof.
    ...
    inversion fg as [fg']; clear fg.
    inversion gf as [gf']; clear gf.
    apply (inverse_ex_bijective lrf g); split.
    -   apply func_eq.
        exact fg'.
    -   apply func_eq.
        exact gf'.
...
Proof.
    intros f.
    exists (tensor_product_lriso_homo M1 M2 N N f (cat_id N)).
    split.
    -   intros f_iso.
...
Theorem tensor_product_liso_eq : ∀ a b, lf (a ⊗1 b) = f a ⊗2 b.
Proof.
...
Proof.
    intros f.
    exists (tensor_product_lriso_homo M M N1 N2 (cat_id M) f).
    split.
    -   intros f_iso.
...
Theorem tensor_product_riso_eq : ∀ a b, rf (a ⊗1 b) = a ⊗2 f b.
Proof.
...
Proof.
    ...
    inversion fg as [fg']; clear fg.
    inversion gf as [gf']; clear gf.
    apply (inverse_ex_bijective rf g); split.
    -   apply func_eq.
        exact fg'.
    -   apply func_eq.
        exact gf'.
