...
exact uses of $\T$ can be found in the Rocq code.
...
\begin{definition} \label{from_equiv}
...
here.  In the Rocq code, this also has the practical benefit that using the ideas
developed here allows parts of the code to not depend on the cardinals, allowing
for more parallelization when compiling it.  Thus, as in the Rocq code, we will
...
be its own type, but I have not managed to figure out how to do this in the Rocq
...
\begin{proof}
    ...
    annoying to work with in Rocq and their use is preferably avoided unless
    needed.
