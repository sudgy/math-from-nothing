...
Another thing that I should point out is that in the Rocq code, I am unable to
make arguments using commutative diagrams.  Because this document is supposed to
mirror the Rocq code, I will not be using commutative diagrams here either.
This is not to say that I prefer not using commutative diagrams.  It's just that
not using them makes this document a better representation of the Rocq code.

A quick note on the order here: In the Rocq code, functors and natural
...
worry about making sure Rocq will know what categories are objects are in, so
...
is mainly because I wanted to reserve $\times$ for other uses in the Rocq code,
