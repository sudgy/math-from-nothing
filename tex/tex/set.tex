...
\begin{theorem} \label{strict-subset-ex}
...
\begin{theorem} \label{set-type-inj}
...
\begin{theorem} \label{image-under-in}
...
\begin{theorem} \label{image-inverse-sub}
...
\begin{theorem} \label{inverse-complement}
...
\begin{theorem} \label{inverse-union}
...
\begin{theorem} \label{simple-finite-sum}
...
\begin{theorem} \label{simple-finite-union}
...
\begin{theorem}[Zorn's lemma on preorders] \label{preorder-zorn}
