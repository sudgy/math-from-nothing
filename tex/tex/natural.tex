...
\chapter{The Natural Numbers} \label{chap-natural}
...
\begin{proof} \label{nat-neq0-leq1}
    For all natural numbers $a$, if $0 \neq a$, then $1 \leq a$.
\end{proof}
\begin{proof}
    By Theorem \ref{nat-le-suc-lt}, then is the same as proving that $0 < a$,
...
\begin{theorem} \label{nat-pow-le-one}
...
\begin{theorem} \label{nat-pow-lt-one}
