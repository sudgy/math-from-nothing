...
Makefile.conf: _CoqProject
	coq_makefile -f _CoqProject -o Makefile_temp
	$(HIDE)rm Makefile_temp
	$(HIDE)rm Makefile.conf
	$(HIDE)rm .Makefile.d
	$(HIDE)mv Makefile_temp.conf Makefile.conf
...
html: $(GLOBFILES) $(VFILES)
	...
	$(HIDE)cp $(EXTRA_DIR)/resources/* html
